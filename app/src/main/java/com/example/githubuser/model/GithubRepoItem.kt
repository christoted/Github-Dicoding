...
data class GithubRepoItem(
    ...
    companion object CREATOR : Parcelable.Creator<GithubRepoItem> {
        override fun createFromParcel(parcel: Parcel): GithubRepoItem {
            return GithubRepoItem(parcel)
        }

        override fun newArray(size: Int): Array<GithubRepoItem?> {
